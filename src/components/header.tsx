...
import { CircleUser, Copy, LogOut } from "lucide-react";
...
export const Header = (props: HeaderProps) => {
  ...
  return (
    <header className="flex justify-between  py-5 px-5">
      <div className="relative z-20 flex items-center text-2xl font-medium text-gray-600">
        <AlertDialog>
      ...
      <div className="flex items-center space-x-4">
        ...
        <p className="hidden lg:block">03:00 • Fri 15 Mar</p>
        <Icons.analytics className="fill-gray-600 h-6 w-6" />
        <Icons.settings className="fill-gray-600 h-6 w-6" />

        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Avatar>
              <AvatarImage
                src="https://img.freepik.com/free-photo/abstract-multi-colored-wave-pattern-shiny-flowing-modern-generated-by-ai_188544-15588.jpg"
                alt="@shadcn"
              />
          ...
          <DropdownMenuContent className="w-56">
            ...
            <DropdownMenuItem onClick={logout}>
              <Icons.analytics className=" fill-gray-600 mr-2 h-4 w-4" />
              <span>Analytics</span>
